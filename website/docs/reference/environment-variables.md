...
| `WANDB_API_KEY` | W&B Inference API key ([wandb.ai/authorize](https://wandb.ai/authorize)) |
| `WANDB_BASE_URL` | Override W&B Inference base URL (default: `https://api.inference.wandb.ai/v1`) |
